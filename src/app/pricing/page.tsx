...
import UpgradeButtom from "@/components/UpgradeButtom";
            ...
            <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
                <div className="mx-auto mb-10 sm:max-w-lg">
                    ...
                    <p className="mt-5 text-gray-600 sm:text-lg">
                        Whether you&apos;r just trying out our service or need more, We&apos;ve get you covered
                    </p>
                </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="p-5">
                                            ...
                                            <p className="my-5 font-display text-6xl font-semibold">Rs.{price}</p>
