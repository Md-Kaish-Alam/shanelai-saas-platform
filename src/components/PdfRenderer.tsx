            ...
            <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
                ...
                <div className='space-x-2'>
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                            {scaleList.map((scale) => (
                                <DropdownMenuItem key={scale.value} onSelect={() => setScale(scale.value)}>{scale.text}</DropdownMenuItem>
                            ))}
                        </DropdownMenuContent>
                    </DropdownMenu>

                    <Button aria-label='rotate 90 Deg' variant='ghost' onClick={() => setRotation((prev) => prev + 90)}>
