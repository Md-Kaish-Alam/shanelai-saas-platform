        ...
        <DropdownMenu>
                    ...
                    <Avatar className="relative w-8 h-8">
                        {imgUrl ? (
                            <div className="relative aspect-square h-full w-full">
                                <Image fill src={imgUrl} alt="profile" referrerPolicy="no-referrer" />
                            </div>
                        ) : (
                            <AvatarFallback>
            ...
            <DropdownMenuContent className="bg-white" align="center">
                <div className="flex items-center justify-start gap-2 p-2">
                    <div className="flex flex-col spave-y-0 5 leading-none">
                ...
                <DropdownMenuItem className="cursor-pointer flex justify-between gap-2 items-center">
                    <LogoutLink>Log Out </LogoutLink>
                    <LogOutIcon className="text-zinc-600 h-4 w-4" />
                </DropdownMenuItem>
